  ...
  <tbody>
    ...
    while ($datos=$sql->fetch_object()){?>
        <tr>
            ...
            <td>
              <a href="" data-toggle="modal" data-target="#exampleModal<?=$datos->id_cargo ?>" class="btn btn-warning btn-sn"><i class="fa-solid fa-pen-to-square"></i></a>
              ...
              <div class="modal-body">
                <form action="" method="POST">
                  ...
                  <div class="fl-flex-label mb-4 px-2 col-12 ">
                    <input type="text" placeholder="Nombre" class="input input__text" name="txtnombre" value="<?=$datos->nom_cargo ?>">
                  </div>
