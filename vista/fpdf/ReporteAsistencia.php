...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE ASISTENCIAS Y ACTIVIDADES DIARIAS "), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('Reporte de asistencias diarias.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
